          ...
          <div class="col-md-3">
            ...
            <div class="card bg-light d-flex flex-fill">
                <div class="card-header text-muted border-bottom-0">
                  <?php echo $miembro['ocupacion']; ?>
                </div>
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead"><b><?php echo $miembro['nombre']; ?> <?php echo $miembro['apellido']; ?></b></h2>
                      <p class="text-muted text-sm"><b>About: </b> Web Designer / UX / Graphic Artist / Coffee Lover </p>
                      <ul class="ml-4 mb-0 fa-ul text-muted">
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Dirección: <?php echo $miembro['direccion']; ?></li>
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Phone #: <?php echo $miembro['telefono']; ?> / <?php echo $miembro['celular']; ?></li>
                      </ul>
                    </div>
...
const Lista_ent = async () => {
    ...
    const res = await fetch('tabla_ref/api_consultas.php?consulta=camarabyservidor&idnvr=<?php echo remove_junk($detalle_form['idnvr']); ?>');
